...
export const SEARCH_INTENTS: SearchIntent[] = [
  ...
  { intent: 'plan your next adventure', searchTerm: 'map to nearest national park' },
  ...
  { intent: 'translate a word you do not know', searchTerm: 'translation of word "hello" in japanese' },
  { intent: 'meaning of a word you do not understand', searchTerm: 'meaning of word "serendipity"' },
  ...
  { intent: 'search for diy home decor ideas', searchTerm: 'diy home decor ideas' },
